...
<!--                            <label for="email"> <?= i::__('E-mail') ?> </label> -->
                    ...
                    <div class="login__buttons">
                        ...
                        <div v-if="(configs && configs.strategies && configs.strategies.Google && configs.strategies.Google.visible) || (configs && configs.strategies && configs.strategies.govbr && configs.strategies.govbr.visible)" class="divider"> 
                        ...
                        <div class="login__social-buttons" :class="{'login__social-buttons--multiple': multiple}">
                            <a v-if="configs && configs.strategies && configs.strategies.govbr && configs.strategies.govbr.visible" class="social-login--button button button--icon button--large button--md govbr" href="<?php echo $app->createUrl('auth', 'govbr') ?>">                                
                                <div class="img"> <img height="16" class="br-sign-in-img" src="<?php echo $app->baseUrl . 'plugins/MultipleLocalAuth/assets/img/govbr-white.png'; ?>" /> </div>                                
                                <?= i::__('Entrar com Gov.br') ?>                            
                            </a>

                            <a v-if="configs && configs.strategies && configs.strategies.Google && configs.strategies.Google.visible" class="social-login--button button button--icon button--large button--md google" href="<?php echo $app->createUrl('auth', 'google') ?>">                                
                                <div class="img"> <img height="16" src="<?php echo $app->baseUrl . 'plugins/MultipleLocalAuth/assets/img/g.png'; ?>" /> </div>                                
                                <?= i::__('Entrar com Google') ?>
                            </a>

                            <a v-if="configs && configs.strategies && configs.strategies.decidim && configs.strategies.decidim.visible" class="social-login--button button button--icon button--large button--md govbr" href="<?php echo $app->createUrl('auth', 'decidim') ?>">                                
